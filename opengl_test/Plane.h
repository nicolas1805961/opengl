...
public:
	Plane();
	Plane(Vector3 const& diffuse, Vector3 const& specular, Vector3 const& translation, float scale = 1.0f, float degreeAngle = 0.0f,
	...
	Plane(Vector3 const& translation, float scale = 1.0f, float degreeAngle = 0.0f, Vector3 const& axis = Vector3(1.0f), bool light = false,
