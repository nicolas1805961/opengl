...
public:
	Plane();
	Plane(std::string const& name, Vector3 const& diffuse, Vector3 const& specular, Vector3 const& translation, float scale = 1.0f, bool isLamp = false, float degreeAngle = 0.0f,
