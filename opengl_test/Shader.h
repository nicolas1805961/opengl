...
public:
	...
	Shader(const std::string& vertex_shader, const std::string& tessellation_control_shader, const std::string& tessellation_evaluation_shader, const std::string& fragment_shader, ShaderType const& shaderType);
	Shader(const std::string& vertex_shader, const std::string& tessellation_control_shader, const std::string& tessellation_evaluation_shader, const std::string& geometry_shader, const std::string& fragment_shader, ShaderType const& shaderType);
	void bind() const;
	//void unbind() const;
...
private:
	...
	unsigned int create_shader(const std::string& vertex_shader, const std::string& tessellation_control_shader, const std::string& tessellation_evaluation_shader, const std::string& fragment_shader);
	unsigned int create_shader(const std::string& vertex_shader, const std::string& tessellation_control_shader, const std::string& tessellation_evaluation_shader, const std::string& geometry_shader, const std::string& fragment_shader);
